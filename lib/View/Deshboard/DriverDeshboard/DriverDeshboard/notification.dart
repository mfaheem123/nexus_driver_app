...
class NotificationsScreen extends StatelessWidget {
  final List<Map<String, dynamic>> notifications = [
    ...
    {
      "title": "Riunione del gruppo Casavatore in MoVimento - forum M5S",
      "time": "23 hours ago",
      "avatar": "https://via.placeholder.com/150",
      "unread": false,
    },
                ...
                children: [
                  ...
                  Container(
                    decoration: const BoxDecoration(
                      ...
                      color: Color.fromARGB(255, 91, 19, 128),                                              // yha pr color hai --------------------------------
                    ),
                ...
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      color: Colors.grey.shade200,                                                          // yha pr color hai --------------------------------
                    ),
                    child: const Row(
                      children: [
                        CircleAvatar(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                "Yesterday",
                                style: TextStyle(
                                  color: Colors.grey,                                                           // yha pr color hai -------------------------------
                                  fontSize: 13,
                                ),
                              ),
                            ],
