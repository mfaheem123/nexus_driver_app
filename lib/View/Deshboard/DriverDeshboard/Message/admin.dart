...
import 'package:driver_app_alpha/Controller/admin_controller.dart';
...
class AdminMessage extends StatelessWidget {
  ...
  final ChatAdmin controller = Get.put(ChatAdmin());
  ...
  void _openSuggestionSheet() {
    Get.bottomSheet(
      AddsuggestionWidget(
        onSelect: (value) {
          inputController.text = value; // selected text field me ajaye
