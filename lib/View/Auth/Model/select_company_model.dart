...
//
//     final selectCompanyModel = selectCompanyModelFromJson(jsonString);

import 'dart:convert';

SelectCompanyModel selectCompanyModelFromJson(String str) => SelectCompanyModel.fromJson(json.decode(str));

String selectCompanyModelToJson(SelectCompanyModel data) => json.encode(data.toJson());

class SelectCompanyModel {
  bool? status;
  int? count;
  List<Driver>? drivers;
  ...
  factory SelectCompanyModel.fromJson(Map<String, dynamic> json) => SelectCompanyModel(
    status: json["status"],
    count: json["count"],
