                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        Text(
                          "Fare :",
                          style: gilroySemiBold(fontSize: 25, color: Color(0xff5A253F
                          ), fontWeight: FontWeight.bold),
                        ),
                        Text(
                          " 29€",
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Text(
                            "I am on the Way",
                            style: gilroySemiBold(fontSize: 20, color: Colors.blue[900], fontWeight: FontWeight.bold),
                          ),
                        )
                      ],
                    ),
  ...
  Widget buildInfoSection({required String title, required IconData icon, required String text}) {
    return Column(
      ...
      children: [
        Text(
          title,
          style: gilroySemiBold(fontSize: 25, color: Colors.blue[900], fontWeight: FontWeight.bold),
        ),
        const SizedBox(height: 20),
        Row(
          children: [
            Icon(icon, size: 22, color: Color(0xff5A253F
            )),
            const SizedBox(width: 5),
            Expanded(
              child: Text(
                text,
                style: gilroySemiBold(fontSize: 15, color: Colors.black, fontWeight: FontWeight.bold),
              ),
            ),
          ],
        ),
          ...
          Positioned(
            ...
            child: GestureDetector(
              ...
              child: Container(
                width: 70,
                height: 70,
                decoration: const BoxDecoration(color: Color(0xffD1F080
                ), shape: BoxShape.circle),
